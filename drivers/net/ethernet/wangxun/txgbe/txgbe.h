...
#ifdef TXGBE_SUPPORT_DEEPIN_SW
#define TXGBE_DEFAULT_TXD               1024
#define TXGBE_DEFAULT_TX_WORK   512
#else
...
#ifdef TXGBE_SUPPORT_DEEPIN_SW
#define TXGBE_DEFAULT_RXD               1024
#define TXGBE_DEFAULT_RX_WORK   512
...
#ifdef TXGBE_SUPPORT_DEEPIN_SW
#define TXGBE_DEFAULT_FCPAUSE 0x3800
#else
...
#ifdef TXGBE_SUPPORT_DEEPIN_SW
#define TXGBE_RX_BUFFER_WRITE   512
#else
...
#define TXGBE_MAX_JUMBO_FRAME_SIZE      9728 /* 9.5KB */
#if IS_ENABLED(CONFIG_FCOE)
