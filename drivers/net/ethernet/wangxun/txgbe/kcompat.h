...
/* if support kylinOS on FT, please open this switch */
/* #include "txgbe_ft_kylin.h" */
/* if support deepin on Shenwei, please open this switch */
/* #include "txgbe_sw_deepin.h" */
/* if support kylinOS on Shenwei, please open this switch */
/* #include "txgbe_sw_kylin.h" */

/* For Kylin:
 * support Kylin-4.0.2-SP2-17122218.j1-arm64 */
#if defined(TXGBE_SUPPORT_KYLIN_FT) || defined(TXGBE_SUPPORT_KYLIN_SW)
...
#define SLE_VERSION_CODE SLE_VERSION(11, 1, 0)
		...
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 0, 26)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 0, 31)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 0, 34)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 0, 38)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 0, 42)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 0, 51)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 0, 58)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 0, 74)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 0, 80)))
/* SLES11 SP2 GA is 3.0.x */
...
#elif ((LINUX_VERSION_CODE == KERNEL_VERSION(3, 0, 82)))
#define SLE_VERSION_CODE SLE_VERSION(11, 3, 1)
#elif ((LINUX_VERSION_CODE == KERNEL_VERSION(3, 0, 93)))
  #if (SLE_LOCALVERSION_CODE >= SLE_LOCALVERSION(0, 8, 0))
  #define SLE_VERSION_CODE SLE_VERSION(11, 3, 2)
  #else
  #define SLE_VERSION_CODE SLE_VERSION(11, 2, 0)
  #endif
  ...
  #define SLE_VERSION_CODE SLE_VERSION(11, 4, 0)
		...
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 32)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 36)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 38)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 39)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 43)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 44)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 48)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 55)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 60)))
/* SLES12 GA is 3.12.28-4
 * kernel updates 3.12.xx-<33 through 52>[.yy] */
#define SLE_VERSION_CODE SLE_VERSION(12, 0, 0)
#elif ((LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 49))  || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 53)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 57)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 59)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 62)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 67)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 69)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 74)))
/* SLES12 SP1 GA is 3.12.49-11
 * updates 3.12.xx-60.yy where xx={51..} */
#define SLE_VERSION_CODE SLE_VERSION(12, 1, 0)
#elif (LINUX_VERSION_CODE == KERNEL_VERSION(3, 12, 51))
  #if (SLE_LOCALVERSION_CODE > SLE_LOCALVERSION(60, 0, 0))
  #define SLE_VERSION_CODE SLE_VERSION(12, 1, 0)
  #else
  #define SLE_VERSION_CODE SLE_VERSION(12, 0, 0)
  #endif
#elif ((LINUX_VERSION_CODE == KERNEL_VERSION(4, 4, 21)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(4, 4, 38)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(4, 4, 49)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(4, 4, 59)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(4, 4, 74)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(4, 4, 90)))
 ...
 * and 4.4.114-94.11 */
		...
		(LINUX_VERSION_CODE == KERNEL_VERSION(4, 4, 126)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(4, 4, 131)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(4, 4, 132)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(4, 4, 138)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(4, 4, 140)) || \
		(LINUX_VERSION_CODE == KERNEL_VERSION(4, 4, 143)))
#define SLE_VERSION_CODE SLE_VERSION(12, 3, 0)
#elif (LINUX_VERSION_CODE == KERNEL_VERSION(4, 4, 103))
  #if (SLE_LOCALVERSION_CODE > SLE_LOCALVERSION(92, 0, 0))
  #define SLE_VERSION_CODE SLE_VERSION(12, 2, 0)
  #else
  #define SLE_VERSION_CODE SLE_VERSION(12, 3, 0)
  #endif
#elif (LINUX_VERSION_CODE == KERNEL_VERSION(4, 4, 114))
  #if (SLE_LOCALVERSION_CODE < SLE_LOCALVERSION(94, 0, 0))
  #define SLE_VERSION_CODE SLE_VERSION(12, 2, 0)
  #else
  #define SLE_VERSION_CODE SLE_VERSION(12, 3, 0)
  #endif
#elif (LINUX_VERSION_CODE == KERNEL_VERSION(4, 4, 120))
  #if (SLE_LOCALVERSION_CODE < SLE_LOCALVERSION(94, 0, 0))
  #define SLE_VERSION_CODE SLE_VERSION(12, 2, 0)
  #else
  #define SLE_VERSION_CODE SLE_VERSION(12, 3, 0)
 ...
 * Node module parameter of txgbe.
 */
...
/*****************************************************************************
 * WangXun(R) PCI Express Linux Network Driver
 * Copyright(c) 2015 - 2017 Beijing WangXun Technology Co., Ltd.
 *
 * Kernel Compat Parameters:
 * HAVE_SRIOV_CONFIGURE - provide SRIOV configuration interface
 *****************************************************************************/
#define KCPV(major, minor) (((major) << 8) + (minor))
...
#undef HAVE_SRIOV_CONFIGURE
#define HAVE_SRIOV_CONFIGURE KCPV(1, 0)
#endif
#endif /* RHEL6.8 - ~ */
...
#if UBUNTU_VERSION_CODE < UBUNTU_VERSION(4, 0, 0, 0)
#undef HAVE_ENCAP_TSO_OFFLOAD
#endif

#endif /* UBUNTU_VERSION_CODE */

/*****************************************************************************
 * Upstream Community Linux
 *****************************************************************************/
#if (KERNEL_VERSION(4, 0, 0) <= LINUX_VERSION_CODE) && \
    (LINUX_VERSION_CODE < KERNEL_VERSION(4, 7, 0))
#define HAVE_VIRTUAL_STATION
#endif /* 4.0.0 - 4.7.0 */

#if (LINUX_VERSION_CODE < KERNEL_VERSION(4, 7, 0))
#define NETIF_F_GSO_IPXIP4      NETIF_F_GSO_IPIP
#define NETIF_F_GSO_IPXIP6      NETIF_F_GSO_IPIP
#endif /* 4.0.0 - 4.7.0 */
...
#define NETIF_F_GSO_IPIP (NETIF_F_GSO_IPXIP4)
#endif
...
/* For JZCluster kernel 3.8 */
#define HAVE_RXFH_HASHKEY

/*** < Set Default Value > ***/
#ifndef HAVE_SRIOV_CONFIGURE
#define HAVE_SRIOV_CONFIGURE 0
#endif

#if (LINUX_VERSION_CODE >= KERNEL_VERSION(4, 9, 115))
#define SUPPORT_INNER_PROTOCOL_TYPE
#endif
