...
#if defined(CONFIG_OF) && (!(defined(CONFIG_CPU_LOONGSON3) || defined(CONFIG_CPU_LOONGSON2K)))
...
out:
	pr_info("Register cache info finided with err %d\n", err);
