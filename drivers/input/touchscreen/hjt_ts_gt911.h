...
#define GTP_RST_PORT   2// 0x6d//GPE6------------------------------
#define GTP_INT_PORT   1// 25//GPG9
...
#define CLEAR_EXT_INTERRUPT_FLAG() *(volatile unsigned int *)(0x900000001fe1146c) |= 1<<31;
//#define READ_EXT_INTERRUPT_FLAG() readl(REG_IRQTGSRC2)& 0xffff0000//Read INT interrupt flag GPG
#define READ_EXT_INTERRUPT_FLAG() *(volatile unsigned int *)(0x900000001fe11460);
...
*(volatile unsigned int *)(0x900000001fe10530) |= (1<<1);\
*(volatile unsigned int *)(0x900000001fe11470) |= (1<<1);\
*(volatile unsigned int *)(0x900000001fe11474) |= (1<<1);\
}while(0)
